  ...
  type-with =
    ...
    let
      ...
      link-niri-release =
        version:
        fmt.masked-link {
          href = "https://github.com/soulvice/niri/releases/tag/${version}";
                        ...
                        // lib.optionalAttrs has-shader {
                          custom-shader = nullable types.str // {
                            description = ''
                              ...
                              See: ${fmt.bare-link "https://github.com/soulvice/niri/wiki/Configuration:-Animations#custom-shader"}
                            '';
                          };
                        }
                      );
        ...
        let
          ...
          patches =
            ...
            builtins.concatMap (
              patch:
              let
                m = lib.strings.match "${lib.escapeRegex "https://github.com/soulvice/niri/commit/"}([0-9a-f]{40})${lib.escapeRegex ".patch"}" patch.url;
              in
              if m != null then
                [
                  {
            ...
            a.nixos =
              module-doc "nixosModules.niri"
                ''
                  ...
                  - It will enable a binary cache managed by me, soulvice. This helps you avoid building niri from source, which can take a long time in release mode.
                ...
                ''
                {
                  ...
                  z.cache = fake-option "niri-flake.cache.enable" ''
                    ...
                    This cache is managed by me, soulvice, and i use GitHub Actions to automaticaly upload builds of ${pkg-link "niri-stable"} and ${pkg-link "niri-unstable"} (for nixpkgs unstable and stable). By using it, you are trusting me to not upload malicious builds, and as such you may disable it.
