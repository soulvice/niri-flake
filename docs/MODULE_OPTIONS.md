...
#### `debug.enable_color_transformations_capability`
...
**Sub-options:**
#### `layout.default_column_width._module`
...
#### `layout.default_column_width.fixed`
...
#### `layout.default_column_width.proportion`
...
#### `window_rules.open-on-workspace`
...
**Generation Info:**
- Generated on: 2025-11-19 21:25:54 UTC
- Niri commit: e0fe1a8b97c303da017906b18cbb53d3eacc354c
- Workflow run: [\#7](https://github.com/soulvice/niri-flake/actions/runs/19516760389)
